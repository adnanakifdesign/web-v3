...
export function VideoSection() {
  ...
  const videoUrl = "https://49ytijv19uin2wdj.public.blob.vercel-storage.com/DZINR%20Showreel%2009.mp4"
  ...
  return (
    <section className="w-full bg-black py-20 md:py-28">
      {/* Text Header */}
      <div className="max-w-full mx-auto px-4 md:px-6 lg:px-8 mb-6">
        <div className="flex items-center justify-between gap-8">
          <div className="flex items-center gap-8">
            <h2 className="text-[13px] md:text-4xl lg:text-[18px] font-regular text-white leading-tight flex-shrink-0">
              Strategy, Design,
              <br />
              Performance
            </h2>
            <p className="text-[13px] md:text-xl lg:text-[18px] text-white whitespace-nowrap">
              We are a branding studio <br /> that helps businesses.
            </p>
          </div>
          <svg className="w-6 h-6 text-white flex-shrink-0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
