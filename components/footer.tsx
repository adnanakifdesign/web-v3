...
export function Footer() {
  ...
  return (
    <footer className="bg-black text-white py-16 px-1 md:px-8" ref={footerRef}>
      <style>{`
      ...
      <div className="py-12 md:py-16 lg:py-20 flex items-center justify-center mb-16">
      ...
      <div className="max-w-full mx-auto">
        <div className="flex flex-col md:flex-row justify-between gap-16">
          {/* Left Section */}
          <div className="flex flex-col justify-between flex-shrink-0 lg:w-2xl w-lg">
            <div>
              <h2 className="text-2xl lg:text-[48px] font-medium mb-8 leading-tight">
                Design it once. Design it right
              </h2>
              <button className="w-full bg-white text-black py-4 px-6 font-semibold text-lg hover:bg-gray-100 transition-colors">
                Lets Talk →
              </button>
            </div>
            <div className="mt-12">
              <p className="text-[16px] text-gray-400 mb-2">New Business :</p>
              <a
                href="mailto:hello@lozinr.com"
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-sm text-gray-400">
          <p>&copy; {currentYear} lOZ!NR. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
